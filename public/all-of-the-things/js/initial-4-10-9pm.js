...
//also MASSIVE big up to Selvakumar Arumugam for the attrchange function. http://meetselva.github.io/attrchange/ 
...
jQuery(document)
		.ready(
				function($) {
					...
					$('header h1')
							...
							.effect(
									...
									function() {
										...
										$('header h1').switchClass('hide', 'unhide'
												).show();
					...
					$('.workTypes').parent().animate(boxShadowDown, 100);
					$('article').delay(2000).show(1500, function(){
						$('footer').show(1500);
					});

					$('.workTypes').parent().delay(3500).animate(boxShadowUp, 500);
					
					$('.workTypes').parent().click(
							function() {
