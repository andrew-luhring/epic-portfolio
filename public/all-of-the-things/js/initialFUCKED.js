...
jQuery(document).ready(function($) {
		...
		$('#centeringDiv a div').each(function() {
			worktypes.push($(this));
			worktypesA.push($(this).parent());
			console.log(this);
		});
		$('#centeringDiv a').each(function() {
			worktypesA.push($(this));
			console.log(this);
		});
					...
					function fadeThemOut(worktypes) {
						if (worktypes.length > 0) {
							...
							var currentWorkA = worktypesA.shift();
							$(currentWorkA,  currentWork).effect("shake", "easeInOutBack", "slow", function() {
								console.log(this);
