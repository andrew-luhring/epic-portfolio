...
(function (root, factory) {
	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			swfPath: "https://lmscontent.embanet.com/javascript/jPlayer/", // Path to Jplayer.swf. Can be relative, absolute or server root relative.
			solution: "html, flash", // Valid solutions: html, flash. Order defines priority. 1st is highest,
			supplied: "mp3, oga", // Defines which formats jPlayer will try and support and the priority by the order. 1st is highest,
