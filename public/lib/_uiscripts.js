...
jQuery(document).ready(function (d) {
    ...
    d(".workTypes").click(function () {
        ...
        }), d("#galleryDiv").append('<div><p id="temp" style="text-align:center">Click the pic to play with the code</p> <p id="clickToClose">Show</p></div>').show(500), timeoutId = window.setTimeout(y, 2E3), d("#temp, #clickToClose").click(function () {
            timeoutId = window.setTimeout(y,
                200)
        ...
        }), d("#galleryDiv").append('<div><p id="temp">Important point: <br /> This website is also a portfolio piece.</p><p id="clickToClose">Show</p></div>').show(1000), setTimeout(y, 3E3)) : d(this).is("#albumArt") ? d("#largeGallery0").parent().attr({
            href: "http://www.androo.pro/portfolio/bythehand/"
        }) : (d("#galleryDiv").text(), window.clearTimeout(timeoutId));
